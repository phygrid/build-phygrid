...
phy vm create dev-vm --phyos-version 5.0.127 --arch amd64 --memory 4096 --storage 20

# Create headless VM
phy vm create test-vm --headless --storage 15
```
...
**Options:**
- `--memory <memory>` - Override memory allocation
...
phy vm start dev-vm --memory 4096
```
