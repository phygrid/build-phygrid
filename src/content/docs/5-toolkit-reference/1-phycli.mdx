...
- This is particularly useful for organizations with multiple environments (dev, test, prod) that share a common prefix
```bash
...
- Required for most app and resource management commands
...
The `phy app` command group allows you to create, build, deploy, and manage Phygrid applications.
...
Creating a new react app in /Users/zahid/build-phygrid/my-test-app1
Updating package.json with app name, version, and description
✓ App cloned and description uploaded at /Users/zahid/build-phygrid/my-test-app1
...
✓ Successfully created installation. Check it here: https://console.phygrid.com/organisations/6151adcfba90fc00068b847b/apps/installations/68775e6209f9fe0009754f33
Fetching default app settings
✓ Successfully applied settings. It can be found in /Users/zahid/build-phygrid/my-test-app1/src/settings
...
✓ Build successful: /Users/zahid/build-phygrid/my-test-app1/build/build/ombori-stockholm-test.my-test-app1-0.1.0.gridapp
✨  Done in 53.52s.
Publishing gridapp
Looking for an application ombori-stockholm-test.my-test-app1
Looking for a bundle: /Users/zahid/build-phygrid/my-test-app1/build/build/ombori-stockholm-test.my-test-app1-0.1.0.gridapp
...
Uploading /Users/zahid/build-phygrid/my-test-app1/meta/screen1.png...ok
Uploading /Users/zahid/build-phygrid/my-test-app1/meta/screen2.png...ok
Uploading /Users/zahid/build-phygrid/my-test-app1/meta/screen3.png...ok
...
2. **Connect Devices**: In the console, go to Apps → Developer section to find your app
...
- Publishes the app to the Phygrid marketplace
...
3. **Console Integration**: App appears in Phygrid Console under Apps → Developer section
...
Validating template files in /Users/zahid/build-phygrid/my-test-app1/build...
✓ Template files are valid
Creating gridapp file...
✓ Build successful: /Users/zahid/build-phygrid/my-test-app1/build/build/ombori-stockholm-test.my-test-app1-0.1.0.gridapp
```
...
- Uploads to Phygrid marketplace
...
- Converts to Phygrid application format
...
**System Requirements:**
- Active Phygrid account with device access
...
**Arguments:**
- `image` - Image filename (optional, fetches latest released version from Phygrid if not provided)
...
**What it does:**
- Lists available devices for emulation
- Stores selected device configuration
- Sets device context for screen app development
- Enables local testing with real device characteristics
...
phy vm create test-vm --phyos-version 5.0.127 --headless --storage 20
...
```bash
# 1. Flash latest PhyOS image (fetches from Phygrid)
phy flash
