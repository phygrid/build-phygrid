...
In PhyStack, Products represent the core entities for showcasing and managing inventory.
...
Products are centrally maintained through the PhyStack Console and are designed to integrate
...
There are several methods to integrate products into your PhyStack ecosystem, 
...
1. Navigate to **Content → Products** in the PhyStack Console
...
1. Navigate to **Apps → Developer → Access tokens** in the PhyStack Console
