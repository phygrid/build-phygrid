...
In Phygrid apps, you access settings using the `@phystack/hub-client` package. When an installation is deployed to a device, settings values are delivered to devices through twins, which the Hub Client then makes available to your app code.
