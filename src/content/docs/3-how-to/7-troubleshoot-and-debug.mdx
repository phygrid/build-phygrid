...
4. **Wait for target discovery** - after a few seconds, you should see a "Phygrid App" entry appear under "Remote Target"
5. **Start debugging** by clicking the **"Inspect"** link next to the "Phygrid App" entry
