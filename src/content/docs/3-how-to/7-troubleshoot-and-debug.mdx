...
First, establish a port forwarding connection from your laptop to the device. Choose any available port (e.g., 12345):
...
**Prerequisites:** Ensure Google Chrome is installed on your laptop.
