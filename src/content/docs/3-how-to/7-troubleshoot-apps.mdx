...
- Instant deployment of code changes without console publishing
- Direct access to application logs for real-time debugging
- Faster development cycles and testing iterations
- Ability to test configurations and settings immediately
...
4. Choose from the following authentication methods:
   ...
   **Option 3: Default Password**
   ...
   - Uses the default password "123" (not recommended for production)
...
- Use SSH public key authentication for enhanced security
- Avoid using the default password in production environments
