...
To learn about the definition of each field, check out the [Field Definitions](../field-definitions) reference guide.
...
<InfoBox>
  Note: ProductTypeId field should be used as value for a products ProductType
  field
</InfoBox>
```json
type ProductType = {
