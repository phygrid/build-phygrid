...
You'll need access to a Phygrid tenant — your organization's managed environment where apps and devices are registered, deployed, and monitored. If you don't yet have one, please refer to the [Onboarding guide](/getting-started/onboarding) here.
