...
### ✅ A Phygrid Tenant
// KP TODO 2025-06-20: Insert link

You'll need access to a Phygrid tenant — your organization's managed environment where apps and devices are registered, deployed, and monitored. If you don't yet have one, please refer to the Onboarding guide here.

### ✅ Local Development Environment with PhyCLI Installed and Configured

// KP TODO 2025-06-20: Insert link

If you haven't set up CLI on your machine yet, refer to the Getting Started guide.
...
If you run into issues at this stage, refer to the **Debugging & Troubleshooting** section of the documentation.
