...
Go to the [Grid Console](https://console.phygrid.com), and navigate to the Marketplace page. Install the Web Signals app.

![Marketplace](https://media.omborigrid.com/media/5cbac8a388e174147b878cdd/e3d26af0-7eae-11ec-bec9-4dcd0899bd02)

![Web Signals](https://media.omborigrid.com/media/5cbac8a388e174147b878cdd/a0e4c800-7eae-11ec-bec9-4dcd0899bd02)

## Step 2: Configure your app

Copy the script from the console `Settings` to your index.html

![Settings](https://media.omborigrid.com/media/5cbac8a388e174147b878cdd/70f12070-7eaf-11ec-bec9-4dcd0899bd02)
...
Real-time dashboards are available in the [Grid Console](https://console.phygrid.com)
