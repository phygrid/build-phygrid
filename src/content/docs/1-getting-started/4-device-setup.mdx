...
PhyStack runs on a wide variety of devices, from powerful edge computers to virtual environments and even web browsers. This flexibility lets you deploy exactly where you need — whether that's on-site hardware, cloud infrastructure, or development environments.
...
Intel devices and ARM-based Giada DN74 are ideal for production deployments where you need full control and maximum performance. With PhyOS installed, they become completely managed PhyStack devices with:
...
For detailed device setup instructions, visit [learn.phygrid.com](https://learn.phygrid.com/installations/connect-a-new-device-to-an-installation/) and follow the guided setup in the PhyStack Console when connecting a device to an installation.
