...
You can test your applications by setting up VMware and Hyper-V virtual machine devices, or by setting up a web browser device.
...
## Create a test device in a virtual machine

1. Download the latest PhyOS for your virtual machine software: [VMware](https://qr.run/phyos-bundle-vmware-latest) or [Hyper-V](https://qr.run/phyos-bundle-hyperv-latest)
2. Create a virtual machine with the following hardware specifications: 
   - 2GB of RAM or more
   - 2 processor cores or more
   - at least 16GB of internal storage
3. Insert the PhyOS image file to the bootable drive in your virtual machine
4. Adjust the virtual machine settings to set the proper boot order
5. Start the virtual machine
6. Follow the on-screen instructions to install PhyOS
7. Reboot the device when prompted and remove the installation media
8. Virtual machine will now boot into PhyOS

## Connect the device to your application

### Connect a physical or virtual machine device to your application
